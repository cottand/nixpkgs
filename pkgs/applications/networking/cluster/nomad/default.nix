...
rec {
  ...
  nomad_1_5 = generic {
    buildGoModule = buildGo120Module;
    version = "1.5.5";
    sha256 = "sha256-8m0ng6i+JlgJKuzpce3gckrKVXNmjTiMCki1+N/ndio=";
    vendorSha256 = "sha256-RqSabARrCjIjkncWcQUF/WcTd65N2kkbSTlZkMw59ZQ=";
    passthru.tests.nomad = nixosTests.nomad;
    preCheck = ''
  ...
  nomad_1_6 = generic {
    ...
    sha256 = "sha256-8m0ng6i+JlgJKuzpce3gckrKVXNmjTiMCki1+N/FAKE=";
    vendorSha256 = "sha256-RqSabARrCjIjkncWcQUF/WcTd65N2kkbSTlZkMwFAKE=";
    passthru.tests.nomad = nixosTests.nomad;
    preCheck = ''
      export PATH="$PATH:/build/go/bin"
    '';
